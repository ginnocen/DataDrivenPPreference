...
int Bplusdsigmadpt_pp_7TeV_PPbBin()
{
  ...
  infile="../FONLLInputs/fo_Curve_pp_pt_rap24_7TeV.dat";
  outfile="Rootf/outputBplus_pp_pt_rap24_7TeV_PPbBin.root";
  ...
  tlatex->SetTextSize(0.04);
  tlatex->Draw();
  cr->SaveAs("Plots/cBmesonPredFONLLBplusBinning_pp_pt_rap24_7TeV_PPbBin.pdf");
  ...
  canvas->SaveAs("Plots/canvasBplus_pp_pt_rap24_7TeV_PPbBin.pdf");
	...
	leg->Draw("");
	c1->SaveAs("../ResultsBplus/CompFONLLdsigmadpt_7TeV.pdf");
